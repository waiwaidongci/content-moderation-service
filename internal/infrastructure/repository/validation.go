...
func validateRuleBundle(f domain.RuleBundle) error                             { return f.Validate() }
func validateBundleRevision(v domain.BundleRevision, t domain.ValueType) error { return v.Validate(t) }
